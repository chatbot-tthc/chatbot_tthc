...
import {
  ArrowLeft, RefreshCw, AlertTriangle, Users,
  MessageSquare, Clock, Target, LayoutDashboard, FileText,
} from "lucide-react";
import {
...
function KpiCard({ icon, label, value, sub, accent, color }: {
  ...
  return (
    <div
      className="rounded-2xl flex items-center gap-3 p-4 transition-all hover:shadow-lg hover:-translate-y-0.5 duration-200"
      style={{
        ...
        <div className="flex items-center gap-3 relative z-10">
          ...
          <div>
            ...
            <p className="text-[10px] tracking-wider" style={{ color: "#E8C06A" }}>
              Hiệu suất phản hồi & thống kê tra cứu — VNPT TP.HCM
            </p>
          </div>
        </div>
        <div className="flex items-center gap-3 relative z-10">
          ...
          <>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              ...
              <KpiCard
                ...
                sub={`${stats.fallback_count} fallback`}
                color="#1B8A4A"
              />
              <KpiCard
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              >
                <h3 className="text-xs font-bold tracking-wide mb-4" style={{ color: "#7B1818" }}>
                      ...
                      <PieChart>
                        ...
                        >
                          ...
                          <Label
                            value={`${(100 - stats.fallback_rate).toFixed(1)}%`}
                            position="center"
                            fill="#7B1818" fontSize={22} fontWeight="bold"
                          />
                        </Pie>
                        <Tooltip
            ...
            >
              ...
              {stats.top_thu_tuc.length === 0 ? (
                ...
                <ResponsiveContainer width="100%" height={280}>
                  <BarChart
                    data={stats.top_thu_tuc.slice(0, 8)}
                    layout="vertical"
                  ...
                  >
                    ...
                    <YAxis
                      type="category" dataKey="ten_thu_tuc" width={220}
