        ...
        <aside className="w-64 shrink-0 hidden md:flex flex-col m-3 mr-0 rounded-2xl overflow-hidden"
          ...
          <nav className="flex-1 p-3 space-y-2">
            ...
            <Link href="/dashboard"
              ...
              <div className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0" style={{ background: "linear-gradient(135deg,#F5E8D5,#EDD9B8)" }}>
          ...
          <div className="m-3 p-4 rounded-2xl shrink-0"
            ...
            <div className="flex items-center gap-2 mb-3">
              <div className="w-7 h-7 rounded-lg flex items-center justify-center" style={{ background: "linear-gradient(135deg,#C9973C,#E8A020)" }}>
            ...
            {messages.length === 0 && (
              <div className="min-h-full flex flex-col items-center justify-center px-8 py-10">
                <div className="flex flex-col items-center w-full">
                  ...
                  <h2 className="text-3xl font-bold mb-2 text-center" style={{ color: "#5C1010", textShadow: "0 2px 8px rgba(92,16,16,0.15)" }}>
