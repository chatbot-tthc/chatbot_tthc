...
3. Trả lời ĐÚNG TRỌNG TÂM câu hỏi: nếu người dùng hỏi lệ phí thì chỉ trả lời lệ phí, hỏi hồ sơ thì chỉ trả lời hồ sơ, hỏi trình tự thì chỉ trả lời trình tự. Không liệt kê toàn bộ thủ tục khi không cần thiết.
